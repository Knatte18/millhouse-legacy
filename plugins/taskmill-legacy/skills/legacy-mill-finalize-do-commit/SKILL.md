---
name: legacy-mill-finalize-do-commit
...
3. Follow the @taskmill-legacy:legacy-mill-do skill steps to implement the resulting task.
4. Follow the @taskmill-legacy:legacy-mill-commit skill rules to commit and push.
