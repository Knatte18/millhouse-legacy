...
2. Follow the @taskmill-legacy:legacy-mill-do skill steps to implement the next planned task.
3. Follow the @taskmill-legacy:legacy-mill-commit skill rules to commit and push.
