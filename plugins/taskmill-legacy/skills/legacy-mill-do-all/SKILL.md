...
2. Loop until no planned tasks remain (`python ${CLAUDE_SKILL_DIR}/../../scripts/task_get.py --include-planned _millhouse/taskmill/backlog.md` exits with code 1):
