...
The implementation of the loop, the non-progress detection, the receiving-review enforcement, and the round-counter logic live in `plugins/mill/doc/modules/implementer-brief.md` (Thread B's prompt).
